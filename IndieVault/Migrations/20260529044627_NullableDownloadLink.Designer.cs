...
namespace IndieVault.Migrations
{
    ...
    [Migration("20260529044627_NullableDownloadLink")]
    partial class NullableDownloadLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IndieVault.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("IndieVault.Models.DownloadHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IndieVault.Models.DownloadHistory", b =>
                {
                    b.HasOne("IndieVault.Models.Game", "Game")
                        .WithMany()
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IndieVault.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("IndieVault.Models.Game", b =>
                {
                    b.HasOne("IndieVault.Models.ApplicationUser", "Developer")
                        .WithMany()
                        .HasForeignKey("DeveloperId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IndieVault.Models.Engine", "Engine")
                        .WithMany("Games")
                        .HasForeignKey("EngineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IndieVault.Models.Genre", "Genre")
                        .WithMany("Games")
            ...
            modelBuilder.Entity("IndieVault.Models.GamePlatform", b =>
                {
                    ...
                    b.HasOne("IndieVault.Models.Platform", "Platform")
                        .WithMany("GamePlatforms")
            ...
            modelBuilder.Entity("IndieVault.Models.GameTag", b =>
                {
                    ...
                    b.HasOne("IndieVault.Models.Tag", "Tag")
                        .WithMany("GameTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("IndieVault.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
